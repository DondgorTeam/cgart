...
<div class="banner banner-profile">
    <div class="container">
        <div class="banner-profile_user">
            ...
            <a href="/createImage" id="editProfile" class="btn btn-primary">Зураг нэмэх</a>
            @endcan
            <!-- Modal -->
...
<div class="container">
    <div id="signup-form">
        ...
        <form method="POST" action="{{ action('PicturesController@store') }}">
            <div class="panel">
                <div class="panel-body">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label for="path" class="control-label">Нэр:</label>
                            <input class="form-control" type="text" name="name" value="{{ old('name') }}" >
                        </div>
                        <div class="">
